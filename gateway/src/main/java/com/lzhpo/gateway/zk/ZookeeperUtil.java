...
public class ZookeeperUtil {
    ...
    @PostConstruct
    public void init() {
        Stat ypNettyMqStat = exists(MyConstant.YP_NETTY_MQ, null);
        if (ypNettyMqStat == null) {
            createNode(MyConstant.YP_NETTY_MQ, "Yunpeng message push system.");
        }
        Stat ypNettyServerStat = exists(MyConstant.YP_NETTY_MQ, null);
        if (ypNettyServerStat == null) {
            createNode(MyConstant.NETTY_SERVER, "Netty server.");
        }
        Stat ypNettyClientChannelStat = exists(MyConstant.YP_NETTY_MQ, null);
        if (ypNettyClientChannelStat == null) {
            createNode(MyConstant.NETTY_CLIENTID_CHANNELID, "Netty channel client.");
        }
    }
}
